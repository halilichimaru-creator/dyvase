    ...
    questions: [
      {
        ...
        a: 'Oui, nous proposons des contrats de maintenance mensuels incluant : mises à jour de sécurité, sauvegardes, contrections de bugs, et support technique. Nous restons votre partenaire sur le long terme.',
      },
      {
